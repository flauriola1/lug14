...
public class CellulareTest {
	...
	public static void main(String[] args) {
		...
		while(!spegni)
		{
			...
			System.out.println("Scelta 5: Visualizza Quantità Chiamate effettuate");
			System.out.println("Scelta 6: Azzera Chiamate");
			System.out.println("Scelta 7: Spegni Cellulare");
			...
			case 3:
				...
				int minuti = n.nextInt();
				cel.effettuaChiamata(numero, minuti);
				break;
			case 4:
